...
class B52Counter
  ...
  def to_svg
    ...
    xml.svg(xmlns: 'http://www.w3.org/2000/svg', width: '1200', height: '1200') do
        xml.rect(
          x: "0",
          y: "0",
          width: "1000",
        ...
        xml.path(d: PATH, fill: '#343330', id: 'path998', style: 'fill:#302f2e;fill-opacity:1;stroke:#00d300;stroke-opacity:1')
        xml.rect(
          x: x,
          y: y,
          width: width,
