...
aircraft\\
Victory conditions:\\
% \[Victory Point Totals\]\\ % This is a problem for TeX.
US:\\
0-10 Draw\\
...
% \begin{tcolorbox}[colframe=black, colback=white, sharp corners, boxrule=1.5pt, width=0.5\textwidth]
\begin{tcolorbox}[colframe=black, colback=white, sharp corners, boxrule=1.5pt,%
   width=1.1\linewidth,%
   left=1pt,
   right=1pt]
% \fontsize{8pt}{9.5pt}\rmfamily % Smaller serif font
\fontsize{6pt}{7.5pt}\rmfamily % Smaller serif font
